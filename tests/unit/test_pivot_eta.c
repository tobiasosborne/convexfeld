...
void test_pivot_eta_null_basis_returns_error(void) {
    ...
    int result = cxf_pivot_with_eta(NULL, 0, pivotCol, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_ERROR_NULL_ARGUMENT, result);
}

void test_pivot_eta_null_column_returns_error(void) {
    int result = cxf_pivot_with_eta(test_basis, 0, NULL, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_ERROR_NULL_ARGUMENT, result);
}
...
void test_pivot_eta_negative_row_returns_error(void) {
    double pivotCol[] = {1.0, 0.5, 0.2};
    int result = cxf_pivot_with_eta(test_basis, -1, pivotCol, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_ERROR_INVALID_ARGUMENT, result);
}

void test_pivot_eta_row_too_large_returns_error(void) {
    double pivotCol[] = {1.0, 0.5, 0.2};
    int result = cxf_pivot_with_eta(test_basis, 3, pivotCol, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_ERROR_INVALID_ARGUMENT, result);
}

void test_pivot_eta_row_equals_m_returns_error(void) {
    double pivotCol[] = {1.0, 0.5, 0.2};
    int result = cxf_pivot_with_eta(test_basis, test_basis->m, pivotCol, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_ERROR_INVALID_ARGUMENT, result);
}
...
void test_pivot_eta_zero_pivot_returns_minus_one(void) {
    ...
    int result = cxf_pivot_with_eta(test_basis, 0, pivotCol, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
...
void test_pivot_eta_updates_basic_vars(void) {
    ...
    cxf_pivot_with_eta(test_basis, 0, pivotCol, enteringVar, leavingVar, CXF_VAR_AT_LOWER, 0.0, 1);
...
void test_pivot_eta_increments_eta_count(void) {
    ...
    cxf_pivot_with_eta(test_basis, 0, pivotCol, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
...
void test_pivot_eta_sets_eta_type_to_2(void) {
    ...
    TEST_ASSERT_EQUAL_INT(CXF_ETA_PIVOT, test_basis->eta_head->type);
}

void test_pivot_eta_sets_eta_pivot_row(void) {
    double pivotCol[] = {2.0, 0.5, 0.25};
    cxf_pivot_with_eta(test_basis, 1, pivotCol, 0, 4, CXF_VAR_AT_LOWER, 0.0, 1);

    TEST_ASSERT_EQUAL_INT(1, test_basis->eta_head->pivot_row);
}

void test_pivot_eta_sets_eta_entering_var(void) {
    double pivotCol[] = {2.0, 0.5, 0.25};
    int enteringVar = 2;
    cxf_pivot_with_eta(test_basis, 0, pivotCol, enteringVar, 3, CXF_VAR_AT_LOWER, 0.0, 1);

    TEST_ASSERT_EQUAL_INT(enteringVar, test_basis->eta_head->entering_var);
}
...
void test_pivot_eta_last_row_pivot(void) {
    ...
    int result = cxf_pivot_with_eta(test_basis, 2, pivotCol, 0, 5, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_OK, result);
...
void test_pivot_eta_middle_row_pivot(void) {
    ...
    int result = cxf_pivot_with_eta(test_basis, 1, pivotCol, 0, 4, CXF_VAR_AT_LOWER, 0.0, 1);
    TEST_ASSERT_EQUAL_INT(CXF_OK, result);
...
void test_pivot_eta_multiple_pivots_chain_etas(void) {
    ...
    cxf_pivot_with_eta(test_basis, 0, pivotCol1, 0, 3, CXF_VAR_AT_LOWER, 0.0, 1);
    cxf_pivot_with_eta(test_basis, 1, pivotCol2, 1, 4, CXF_VAR_AT_LOWER, 0.0, 1);
...
int main(void) {
    ...
    RUN_TEST(test_pivot_eta_sets_eta_entering_var);
